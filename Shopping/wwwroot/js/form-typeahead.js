...
(function(window, document, $) {
  ...
  var countries = new Bloodhound({
    ...
    prefetch: '../../wwwroot/data/countries.json'
  ...
  var bestPictures = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../wwwroot/data/films/post_1960.json',
    remote: {
      url: '../../wwwroot/data/films/queries/%QUERY.json',
      wildcard: '%QUERY'
    }
  });
  ...
  var nflTeams = new Bloodhound({
    ...
    prefetch: '../../wwwroot/data/nfl.json'
  });
  ...
  var nbaTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../wwwroot/data/nba.json'
  });

  var nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../wwwroot/data/nhl.json'
  });
